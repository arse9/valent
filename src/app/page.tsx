...
function TikTokWrappedAppPage() {
  ...
  const paragraphs = [
  "Vennligst sett på spillelisten under denne boksen og deretter trykk 'Neste'",
  ...
  "454 dager siden vi ble sammen.",
  "454 dager med latter, kjærlighet, gode minner – og selvfølgelig noen små irritasjoner her og der, men mest av alt, 454 dager med deg.",
